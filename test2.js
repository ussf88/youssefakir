...
function pageTransition() {
    ...
    tl.to('div.introduction div', { duration: .5, transform: "translateY(-100%)", opacity: 0 });
    tl.set(".introduction", { transformOrigin: "98.08% 30.3%" });
...
function contentAnimation() {
    ...
    tl.set(".introduction", { transformOrigin: "50% 50%" });
    tl.from('div.introduction div', { duration: .5, transform: "translateY(-100%)", opacity: 0 });
